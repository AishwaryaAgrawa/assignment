<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="repeater1.aspx.cs" Inherits="_2_nov_2020.repeater1" %>
    ...
    <form id="form1" runat="server">
        <div style="background-color:lime">
            ...
            <tr>
                ...
                <td rowspan="5"><asp:Image ID="image1" runat="server" Width="100px" ImageUrl='flight.jpg<% #Eval("StudentImage")%>'></asp:Image></td>
                <td>&nbsp;</td>
            </tr>
        </table>
